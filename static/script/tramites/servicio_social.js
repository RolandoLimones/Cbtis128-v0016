        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Aplicar animación a los cuadros de requisitos
            const cuadrosRequisitos = document.querySelectorAll('.cuadro-requisito');
            cuadrosRequisitos.forEach(cuadro => {
                observer.observe(cuadro);
            });

            // Aplicar animación a la nota destacada
            const cuadroNota = document.querySelector('.cuadro-nota');
            if (cuadroNota) {
                observer.observe(cuadroNota);
            }
        });